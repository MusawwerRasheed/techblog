...
@section('content')
  ...
  text-shadow: 1px 1px 1px #000000;"> <strong> Create Tag   <i style="color: #6ed3cf" class="fas fa-tags"></i> </strong> <a href="/tag/index/"><i  style=" font-size: 42px ;float: right;color: #6ed3cf" class="far fa-arrow-alt-circle-left"></i></a></h1>
...
"class="btn btn-success" type="submit"><i class="fas fa-plus-circle"></i> Create Tag</button>
                                </div>
                            </div>
