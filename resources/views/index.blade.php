...
<head lang="en">
    ...
    <link rel="icon" type="image/ico" href="/uploads/posts/capture2.png"/>
                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <h2 class="post__title entry-title ">
                                <a href=" {{route('post.single',['slug'=>$first_post->slug])}}">{{$first_post->slug}}</a>
                            </h2>
...
{{--                    <a href=" {{route('post.single',['slug'=>$first_post->title])}}">{{$first_post->title}}</a>--}}
                    <div class="post__content">

                        <div class="post__content-info">

                            <h2 class="post__title entry-title ">
                                <a href="{{route('post.single',['slug'=>$secound_post->title])}}">{{$secound_post->title}}</a>
                            </h2>
                            ...
                            <div class="post-additional-info">
                                        ...
                                        <span class="post__date">
                                            ...
                                            <time class="published" datetime="2016-04-17 12:00:00">
                                                {{$secound_post->created_at->diffForhumans()}}
                                            </time>
                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <div class="post-additional-info">
                                ...
                                <span class="post__comments">
                                            <a href="{{ route('category.single',['id'=>$third_post->category->id])}}"><i class="fa fa-comment-o" aria-hidden="true"></i></a>
                                            6
                                        </span>
                ...
                <div class="col-lg-12">
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                  <a href="{{route('category.single',[$laravel->id])}}"><h4 class="h1 heading-title">{{$laravel->name}}</h4></a>
                    ...
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                  <a href="{{route('category.single',[$javascript->id])}}">  <h4 class="h1 heading-title">{{$javascript->name}}</h4></a>
                                    <div class="heading-line">
                                        <span class="short-line"></span>
                                        <span class="long-line"></span>
                                    </div>
                    ...
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                   <a href="{{route('category.single',[$angular->id])}}"> <h4 class="h1 heading-title">{{$angular->name}}</h4></a>
                                    <div class="heading-line">
                                        <span class="short-line"></span>
                                        <span class="long-line"></span>
                                    </div>
                                ...
                                @foreach($angular->posts()->orderBy('created_at','desc')->take(3)->get() as $post)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            ...
                                            <h6 class="case-item__title text "><a href="{{route('post.single',['slug'=>$post->slug])}}"> {{$post->title}} </a></h6>
                                        </div>
                                    </div>
